            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '192.168.100.159')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=epsi,dc=fr'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'EPSI\Administrateur'),
                'password' => env('LDAP_PASSWORD', 'Epsi#1234!'),
